  ...
  <div class="app-container">
    <div class="scene-container">
      ...
      <div class="start-calculate">
        ...
        <button class="toCalculate" @click="goCalResult"
          >开始测算
        </button>
      </div>
      <!-- 是否显示  光伏start-->
            ...
            >
              <el-row :gutter="20">
                <el-col :span="7">
                  ...
                  <el-input
                    v-model="lightForm.device_capacity"
                    placeholder=""
                  />
                </el-col>
                <el-col :span="7">
                ...
                <el-col :span="7">
                  ...
                  <el-input v-model="lightForm.local" placeholder="" />
                </el-col>
                <el-col :span="7">
                ...
                <el-col :span="7">
                  ...
                  <el-input
                    v-model="lightForm.produce_use_rate"
                    placeholder=""
                  />
                </el-col>
                <el-col :span="7">
                ...
                <el-col :span="7" v-if="lightIsShow">
                  ...
                  <el-input
                    v-model="lightForm.selling_vat_rate"
                    placeholder=""
                  />
                </el-col>
                <el-col :span="7" v-if="lightIsShow">
                ...
                <el-col :span="7" v-if="lightIsShow">
                  ...
                  <el-input
                    v-model="lightForm.income_tax_rate"
                    placeholder=""
                  />
                </el-col>
              </el-row>
            ...
            >
              <el-row :gutter="20">
                ...
                <el-col :span="7" v-if="StorageIsShow">
                  ...
                  <el-input
                    v-model="storageForm.cycles_number"
                    placeholder=""
                  />
                </el-col>
                <!-- <el-col :span="7" v-if="cnIsshow">
                  <el-form-item label="电池衰减率"></el-form-item>
                  <el-input  v-model="cnform.battery_reduction_rate" placeholder="" />
                </el-col> -->
                <el-col :span="7" v-if="StorageIsShow">
                  <el-form-item label="充放电策略"></el-form-item>
                  <el-input
                    v-model="storageForm.charge_policy"
                    placeholder=""
                  />
                </el-col>
                <el-col :span="7" v-if="StorageIsShow">
            ...
            <el-form :inline="true" v-model="pileForm" class="demo-form-inline">
              <el-row :gutter="20">
                ...
                <el-col :span="7">
                  ...
                  <el-input
                    v-model="pileForm.pile_service_fee"
                    placeholder=""
                  />
                </el-col>
                <el-col :span="7">
